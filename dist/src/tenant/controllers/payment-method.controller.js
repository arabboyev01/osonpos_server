...
let PaymentMethodController = class PaymentMethodController {
    ...
    update(req, id, dto) {
        return this.paymentMethodService.update(req.user.dbName, req.user.id, id, dto);
    }
    remove(req, id) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, payment_method_dto_1.UpdatePaymentMethodDto]),
    __metadata("design:returntype", void 0)
